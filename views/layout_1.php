...
<html lang="en">
	<head>
		...
		<link href="views/themes/css/bootstrappage.css" rel="stylesheet"/>
		
		<!-- global styles -->
		<link href="views/themes/css/flexslider.css" rel="stylesheet"/>
		<link href="views/themes/css/main.css" rel="stylesheet"/>

		<!-- scripts -->
		<script src="views/themes/js/jquery-1.7.2.min.js"></script>
		<script src="views/css/js/bootstrap.min.js"></script>				
		<script src="views/themes/js/superfish.js"></script>	
		<script src="views/themes/js/jquery.scrolltotop.js"></script>
		<!--[if lt IE 9]>			
        ...
        <div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
                                    <a href="layout_1.php.html" class="logo pull-left"><img src="themes/images/logo.png" class="site_logo" alt=""></a>
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="./views/types/readAll.php">Woman</a>					
								<ul>
									<li><a href="../views/types/readAll.php">Lacinia nibh</a></li>									
									<li><a href="./views/types/readAll.php">Eget molestie</a></li>
									<li><a href="./views/types/readAll.php">Varius purus</a></li>									
								</ul>
							</li>															
							<li><a href="./views/types/readAll.php">Man</a></li>			
							<li><a href="../views/types/readAll.php">Sport</a>
								<ul>									
									<li><a href="./views/types/readAll.php">Gifts and Tech</a></li>
									<li><a href="./views/types/readAll.php">Ties and Hats</a></li>
									<li><a href="./views/types/readAll.php">Cold Weather</a></li>
								</ul>
							</li>							
							<li><a href="./views/types/readAll.php">Hangbag</a></li>
							<li><a href="./views/types/readAll.php">Best Seller</a></li>
							<li><a href="./views/types/readAll.php">Top Seller</a></li>
						</ul>
					</nav>
				</div>
			</section>
